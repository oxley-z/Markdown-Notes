...
安装完成后的claude在`C:\Users\asus\.local\bin`目录下存在claude.exe则说明安装成功；

# 配置环境变量

将claude.exe的文件位置加入到环境变量中：

![](image/Claude安装使用/IMG-20260418192446928.png)
...
![](image/Claude安装使用/IMG-20260418193026886.png)
...
[Environment]::SetEnvironmentVariable("sk-76def535e30e4a209bf96ff6b99cb4fb", "YOUR_DASHSCOPE_API_KEY", [EnvironmentVariableTarget]::User)
...
[Environment]::SetEnvironmentVariable("ANTHROPIC_MODEL", "glm-5", [EnvironmentVariableTarget]::User)
```
