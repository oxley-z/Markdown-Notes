...
author: 秋芝2046
source: 微信公众号
url: https://mp.weixin.qq.com/s?__biz=MzkzMDU2Nzg3MQ==&mid=2247491556&idx=1&sn=8ddaff5735e1fe782707ad7b912def7b&chksm=c3a88bc3af02f5d3d5998120132e6f36d9d4554d73c10193c74e31ce88d3b0246f8946378092&mpshare=1&scene=1&srcid=0507bfGDTSliMsgKkYLW60qv&sharer_shareinfo=9e39eface26ed952b08f297f484dbb97&sharer_shareinfo_first=9e39eface26ed952b08f297f484dbb97#rd
saved: 2026-05-07 22:13:47
tags:
  - 笔记同步助手
id: c85a825f-5087-47cd-9ec8-425d444ef4bc
---
...
发布时间：2026-05-05 22:08

雷猴啊朋友们～

Claude Code（简称cc），可能是过去一年里持续爆火、也最实用的AI Agent了，不管你是程序员还是其他脑力工作者，都该用它！

但 cc 也是公认门槛比较高的工具，所以​咱花了一个多星期做了上面这期60分钟的视频，让每个小白都能从 0 掌握 cc！

🎬视频里知识点最全、操作最完整～从安装、配置模型、跑通第一个项目，到上下文管理、记忆机制、Skill / MCP / SubAgent 等高级扩展，每一步都跟得上、跑得通～很多细节和踩坑提示图文里装不下，全在视频里～

想全面掌握cc，强烈推荐先看视频！

![[Inbox/笔记同步助手/images/c4c0f0be8e1c2393aa154577d63434da_MD5.gif]]

📎配套文档：视频里提到的命令、工具、skill 全都打包好了！​跟着视频操作的时候随用随查👇

> **https://my.feishu.cn/wiki/Takxwov60iO5OOkOmpEcpOGynac**

📖 图文教程：没时间看视频也没关系，你正在读的这一篇就是图文教程～读完知道 cc 整体能干什么、自己该从哪一关入手，适合先建立全局认知，或者​看完视频回来查漏～

那我们现在出发～

![[Inbox/笔记同步助手/images/a3d1a1ca86e7005fe892b070c2ff0e4e_MD5.jpg]]
...
![[Inbox/笔记同步助手/images/fb6179612d6408e9f30b2e41cb25faac_MD5.jpg]]
...
![[Inbox/笔记同步助手/images/9cb74dc154277d05809e398839fdb23c_MD5.jpg]]
...
![[Inbox/笔记同步助手/images/8c5e36cdfd211976b3a8aa3efbb5eb70_MD5.jpg]]
...
![[Inbox/笔记同步助手/images/cbc6b70197a1357bf3ab77286f10adf6_MD5.jpg]]
...
![[Inbox/笔记同步助手/images/12bac9393159063b8bfcd24fb0840f87_MD5.jpg]]

虽然小白会认为终端听着陌生，但配合一个 Agent IDE其实非常顺，不需要买会员，薅免费额度就好了，

我们以 cursor 为例。先去官网下载 cursor，

![[Inbox/笔记同步助手/images/a0b6494d48675a3ab30cd9f76b5012d8_MD5.jpg]]

打开后创建一个文件夹作为第一个项目就好了，

![[Inbox/笔记同步助手/images/75dabe1ff02c3172d32b3e3e67196dc9_MD5.jpg]]

![[Inbox/笔记同步助手/images/d2e293a868b780b9437acb09481d0677_MD5.jpg]]

cc 安装有两种方式，不管你是Windows或者Mac都可以装～

## 2.1.1 一行命令安装（需魔法）

在官网https://code.claude.com/docs/zh-CN/overview拷贝命令，在 ide 终端里输入回车，自动下载好。

![[Inbox/笔记同步助手/images/cae3c9c2c63f59225d0008f890f10b53_MD5.jpg]]

再输入`claude --version`，看到版本号就成功了。

![[Inbox/笔记同步助手/images/9bba40c4172a83e25944385bac802d01_MD5.jpg]]
...
![[Inbox/笔记同步助手/images/ae6aca4aa3f939da7984275707a5edc9_MD5.jpg]]
...
![[Inbox/笔记同步助手/images/0108c0689814611f4facd74617a27147_MD5.jpg]]

但能用上的人不多，更多朋友会用国产大模型或其他渠道的 api。建议下载 cc switch 来管理多个模型的切换，直接按这个链接去下载👇https://github.com/farion1231/cc-switch/releases

填入 apikey 和 baseurl，随意起名保存就行。

![[Inbox/笔记同步助手/images/651f3ace8909ca9e07166371a6252039_MD5.jpg]]

> ⚠️**容易踩的坑**：操作cc switch一定要在打开claude**之前，**否则它默认会让你登录。已经在 cc 里面再去切，会切不动。这一步很多新手翻车，记一下～

![[Inbox/笔记同步助手/images/5ef081244b54d04e21a4f71db8943e09_MD5.jpg]]

回到 ide，输入 claude 回车启动。一些初始设置（主题色、安全提示、推荐设置、文件夹是否可信），一般全部回车通过就好啦～

![[Inbox/笔记同步助手/images/a2cdbb491751564f8f2677c6a6b8848c_MD5.jpg]]
...
![[Inbox/笔记同步助手/images/441ae9030093321b8a027737dcf4f571_MD5.jpg]]

如果我们自己不太懂技术栈，就选第一个。

它进入了 plan mode（计划模式），先给一个详尽的计划。

![[Inbox/笔记同步助手/images/e71ce9810e98a2b5ae21727bbe4ff6f5_MD5.jpg]]
...
![[Inbox/笔记同步助手/images/da7f87d2178707e9d745d1672935c80e_MD5.jpg]]

切换快捷键 Shift + Tab，可以在这三种模式循环切换。

还有一个一路绿灯不问你的危险模式，启动时加 \--dangerously-skip-xx 参数。Anthropic 自己发现 97% 情况下用户都是直接同意的。

![[Inbox/笔记同步助手/images/96c4af91527643f47d7fe7878ced2071_MD5.jpg]]

我个人是用最危险的权限了，​新手建议从默认模式起手～

确认计划后，cc 开始创建代码。

![[Inbox/笔记同步助手/images/6c6475398459ac2164daae406b4835be_MD5.jpg]]

安装项目依赖时它会再问，因为这是终端命令而不仅是文件编辑。这种情况选「同意，并且这个项目以后执行 npm 安装的时候不再询问」最方便。

![[Inbox/笔记同步助手/images/85bae71e1131252ed3fbbc43c76bbc4c_MD5.jpg]]

## 2.4 跑起来

它装好后会告诉我们运行命令。

![[Inbox/笔记同步助手/images/6e4aa0de32705cb040444a028ed05eb7_MD5.jpg]]
...
![[Inbox/笔记同步助手/images/b76a2a4548bdba54d093f19bfb4341fc_MD5.jpg]]

输入 ! 跑了项目会阻塞跟 cc 的对话。可以输入 Ctrl+B 让它在后台运行，不影响继续聊。

![[Inbox/笔记同步助手/images/c86ec2c6f898e479a8a5611343d150db_MD5.jpg]]

## 2.5 跟 CC 交互的几种方式

除了打字对话，cc 还有几种交互方式，

![[Inbox/笔记同步助手/images/6a2c30f8e1c8222a58700c4c6a1b1261_MD5.jpg]]

## 2.5.1 @文件

![[Inbox/笔记同步助手/images/01fba21b79ccd8a0daf4eb4aa023128a_MD5.jpg]]

作用就是更精准地把上下文给到 cc。因为 cc 不会一直把所有项目文件加载到上下文里，尤其项目大了它也加载不进去，它通常会经过 grep 找文件。

![[Inbox/笔记同步助手/images/f7c024d77c3addea4159da058889586d_MD5.jpg]]

所以​当我们明确@一个文件的时候是帮cc提高效率，省我们的token～

很多时候，我们的提示词长了在命令行打字不方便，可以先建一个文档写详细要求，再 @ 这个文档。

![[Inbox/笔记同步助手/images/810e470c9a4cf6d84a219e146bc26f43_MD5.jpg]]
...
![[Inbox/笔记同步助手/images/e13bff568c2c43a717fd88f597a1ff0c_MD5.jpg]]

## 2.5.2 贴图片

直接拖拽图片或粘贴到对话框。比如给一个配色参考让番茄钟做浅色主题，

![[Inbox/笔记同步助手/images/7596d19370679a068a2adc3846891039_MD5.jpg]]

利用上它的多模态能力，出来的效果还是很不错的～

![[Inbox/笔记同步助手/images/83be165157f1309074493c694f4de6f5_MD5.jpg]]

## 2.5.3 斜杠命令

除了上面那两种，cc也支持非常多命令，输入 / 出现命令清单。/help列出所有指令。

![[Inbox/笔记同步助手/images/402ed9af2858e8a4a247ad523ddb2aea_MD5.jpg]]
...
![[Inbox/笔记同步助手/images/333ec684c3d3fb9cb78cabe41f1ff7f7_MD5.jpg]]
...
![[Inbox/笔记同步助手/images/f4fb3ac283a0f403c5a50679cb25ae18_MD5.jpg]]

但这个回滚有局限：只能撤 cc 自己编辑的文件。它执行的终端命令（安装包、下载东西），撤不了。

真正靠谱的后悔药是 Git。

哪怕你不是程序员，只要在用 cc 做项目，Git 都是你的安全网。可以理解成​游戏的存档系统​，打到一个满意的节点存一档，后面翻车就读档回来～

Mac 自带 Git，Windows 让 cc 帮你装。最好建个 GitHub 账号，远程仓库可以让你在其他电脑上拉下存档点继续工作，也方便协作。

![[Inbox/笔记同步助手/images/dbe7948805124fdc361a051412e66728_MD5.jpg]]

git 的下载、安装、登录、提交、回滚，都可以让 cc 用自然语言帮你完成。比如说「帮我下载 Git 并跟我的 GitHub 账号绑定」，跟着操作就好。

![[Inbox/笔记同步助手/images/b2f1b78bd81d8cc4690ee954399f17c9_MD5.jpg]]
...
![[Inbox/笔记同步助手/images/46c0c8c95090d9dd50a3d6c4816d7ee8_MD5.jpg]]
...
![[Inbox/笔记同步助手/images/559fdb4e43cba280b72b48d44677900e_MD5.jpg]]
...
![[Inbox/笔记同步助手/images/d321e6b28686fc03e4f4ee1e8d8fce3c_MD5.jpg]]

每次手动输入太麻烦的话，让 cc 帮你打开常驻显示，重启终端后底部就会显示上下文余量。

恢复对话的话可以进入 cc 后输入 /resume 选择历史对话；或者启动时加\-c 或 \--continue。

![[Inbox/笔记同步助手/images/2fed349627bd15414b95981281114e0c_MD5.jpg]]

我的习惯是看到上下文高于 60% 了，就 /compact 一下～

到这里，你已经对 cc 有了一定的掌控～但它现在对每个人都一样，下一关讲怎么让它个性化服务你。

![[Inbox/笔记同步助手/images/7cf3e1717c58a47ce1f412c575a3704c_MD5.jpg]]
...
理想的工具不该是这样，应该得是​你越用，它该越懂你​——记得你是谁、记得你做的项目、记得你不喜欢什么、记得它上次踩过哪个坑。这一关讲的就是怎么让 cc 真的做到这件事。
...
![[Inbox/笔记同步助手/images/2b32f52c5fe1cae5f3c225e353af697c_MD5.jpg]]

## 4.1.1 全局 claude.md

放在 ～/.claude/CLAUDE.md，对所有项目生效。写跟你个人习惯有关的规则，比如永远用中文回答、永远记住你是谁。

## 4.1.2 项目级 claude.md

放在项目根目录，团队共享，可提交到 Git。比如做番茄钟，希望它记住技术架构、文件结构、开发规范、风格。这些信息写在项目根目录下。

## 4.1.3 文件夹级 claude.md

放在子文件夹中，仅对这个文件夹的修改生效，也可以提交到 Git。

三层叠加生效，不冲突。

创建项目级最常用的方式：输入 /init，cc 自动初始化、扫描项目、生成 claude.md。

![[Inbox/笔记同步助手/images/39e45687f71713fdc4ef1b1d57257407_MD5.jpg]]

那Anthropic 内部也建议，项目有一定规模再用 /init，效果更好。新开对话时 cc 也能第一时间知道整个项目在干嘛，省得它再去扫一遍文件。

创建全局 claude.md 两种方式：直接让 cc 写入，或者输入 /memory 选择全局选项编辑。修改全局后需重启 cc 生效。

大家随着实践，可能会发现 claude.md 不应该塞太多内容，理想情况下它写最顶层基本不变化的原则～比如最近很火的卡帕西 skill 就是几百行通用规则，但已经有10万多 star了。

![[Inbox/笔记同步助手/images/484112a3b468533ab02e1dece3b12573_MD5.jpg]]

项目级 claude.md 应该是动态的：项目加了功能、踩了坑，就同步更新。积累的错误经验越多，犯错越少。

![[Inbox/笔记同步助手/images/0d3acfe51bdb6b74b44aebe4c47edaf5_MD5.jpg]]

## 4.2 Auto Memory：cc 自己的笔记本

第二层记忆。没显式写进 claude.md 的习惯、错误、经验，会被一个跟主会话无关的后台 agent 默默记录下来。

需要手动开启：/memory → 第一个选项打开。打开后会多出「打开自动记忆文件夹」的选项。

![[Inbox/笔记同步助手/images/4b539a8a1859fbc0ac7803e4a55310da_MD5.jpg]]
...
![[Inbox/笔记同步助手/images/2fd14e2b954749cc33724118afa0e15b_MD5.jpg]]

注意 Auto Memory 存在项目目录下，只作用于当前项目，换项目的话就需要重新积累了。

![[Inbox/笔记同步助手/images/7cc806da75ae0d6dd895b54e8e652336_MD5.jpg]]

它也不是每次全部加载。每次打开项目，cc 只读 memory.md 这个索引，遇到具体问题时才按索引读对应文件，不会占用太多上下文。

如果记得不对，直接说「忘掉刚刚说的不喜欢深色主题」，它就删掉了。

小总结：

CLAUDE.md 是第一优先级，全部注入上下文，由你主动立的规矩。

Auto Memory 是第二优先级，在工作过程中由 cc 自己记录、按需注入的规则。

![[Inbox/笔记同步助手/images/fc12a9eac179bf1a182d19bee2e70c29_MD5.jpg]]
...
![[Inbox/笔记同步助手/images/44f834f41d10df6835df6732965adbba_MD5.jpg]]

如果还有文字风格上的要求，再建一个语言规范文件就行～

然后我们可以在 claude.md 里写：当你需要修改前端视觉时去参考这个文件，写产品文字时参考那个文件。

![[Inbox/笔记同步助手/images/f7597c128ecb16bd3389f3c3c5157e19_MD5.jpg]]
...
![[Inbox/笔记同步助手/images/ba856f1cdd32986dfcfab3958293adc7_MD5.jpg]]
...
![[Inbox/笔记同步助手/images/c15af99e4a095bf9497b6f13312e23ad_MD5.jpg]]

这些操作手册不适合全写进 claude.md，但又不止一次会用到。所以 skill 的设计是每次运行 agent，只发给大模型几行元信息（skill 名称和何时调用），让大模型自行决定何时去看说明书。

![[Inbox/笔记同步助手/images/d365bbafb041f5261590db9fed719e7e_MD5.jpg]]

安装：放进对应 skills 文件夹（全局或项目级）就好了。

![[Inbox/笔记同步助手/images/6968de92ce9254c92333d54f0cb8c2ea_MD5.jpg]]
...
![[Inbox/笔记同步助手/images/0a3ce873099f4ba2b4003dc608255495_MD5.jpg]]

比如让 cc 看到你 NotebookLM 的资料、让 cc 读 Figma 设计稿生成代码。

![[Inbox/笔记同步助手/images/78c4dec1f69b95f446b0a16bd16fcffd_MD5.jpg]]
...
![[Inbox/笔记同步助手/images/2520582078485b5d6c0b45142316fed1_MD5.jpg]]
...
![[Inbox/笔记同步助手/images/c1046d9766f1c2715825d6301fcfe8b3_MD5.jpg]]
...
![[Inbox/笔记同步助手/images/653b7a1cfcc2597dd07f4d4ea44c46df_MD5.jpg]]
...
![[Inbox/笔记同步助手/images/5bb8371242de09f496b8482d4505f201_MD5.jpg]]

![[Inbox/笔记同步助手/images/22efca43450e8b881e7a92eb0652fdcd_MD5.jpg]]
...
3.  个性化：claude.md + Auto Memory，让 cc 记住你的要求和它犯过的错。
...
![[Inbox/笔记同步助手/images/a45011f17b70d91501264fb5e4e47c90_MD5.jpg|cover_image]]

Original 秋芝2046 秋芝2046

---

内容效果不满意？[点此反馈](https://feedback.notebooksyncer.com/feedback/d67b3b8e_1778163224517?u=https%3A%2F%2Fmp.weixin.qq.com%2Fs%3F__biz%3DMzkzMDU2Nzg3MQ%3D%3D%26mid%3D2247491556%26idx%3D1%26sn%3D8ddaff5735e1fe782707ad7b912def7b%26chksm%3Dc3a88bc3af02f5d3d5998120132e6f36d9d4554d73c10193c74e31ce88d3b0246f8946378092%26mpshare%3D1%26scene%3D1%26srcid%3D0507bfGDTSliMsgKkYLW60qv%26sharer_shareinfo%3D9e39eface26ed952b08f297f484dbb97%26sharer_shareinfo_first%3D9e39eface26ed952b08f297f484dbb97%23rd&s=obsidian)