...
| 名称                                                    | 描述                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| ----------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ARI（Alternative Routing-ID Interpretation，可选路由 ID 解析） | 它是 PCI Express 规范中的一项扩展能力（Extended Capability）。它的核心作用是**打破传统 PCIe 单个设备最多只能有 8 个功能（Function）的限制，使其最高能够支持 256 个功能**。<br><br>**传统解析方式（非 ARI）**：16 位 Routing ID = **8 位 Bus** + **5 位 Device** + **3 位 Function**。<br>因为 Function 字段只有 3 位，所以一个 PCIe 设备（Device）最多只能提供 $2^3 = 8$ 个物理功能（Func 0 到 Func 7）。<br><br>**ARI 解析方式**： 当开启 ARI 后，PCIe 控制器会改变对这 16 位的解释方式：将原本的 5 位 Device 字段直接借给 Function 使用。<br>16 位 Routing ID = **8 位 Bus** + **8 位 Function**（此时默认 Device 号始终为 0）。<br>8 位 Function 使得单个设备可以支持 $2^8 = 256$ 个功能（Func 0 到 Func 255）。 |
|                                                       |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
# Capability结构
